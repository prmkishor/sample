    ...
    (function (grid) {
        ...
        var SetFilter = (function () {
            ...
            SetFilter.prototype.createGui = function () {
                ...
                this.eListContainer.style.height = (this.model.getUniqueValueCount() * this.rowHeight) / 16 + "em";
                this.setContainerHeight();
            ...
            SetFilter.prototype.setContainerHeight = function () {
                this.eListContainer.style.height = (this.model.getDisplayedValueCount() * this.rowHeight) / 16 + "em";
            };
            ...
            SetFilter.prototype.insertRow = function (value, rowIndex) {
                ...
                eFilterValue.style.top = (this.rowHeight * rowIndex) / 16 + "em";
    ...
    (function (grid) {
        ...
        var PopupService = (function () {
            ...
            PopupService.prototype.positionPopup = function (eventSource, ePopup, keepWithinBounds) {
                ...
                ePopup.style.left = x / 16 + "em";
                ePopup.style.top = y / 16 + "em";
            };
    ...
    (function (grid) {
        ...
        var RenderedCell = (function () {
            ...
            RenderedCell.prototype.setupComponents = function () {
                ...
                this.vGridCell.addStyles({ width: this.column.actualWidth / 16 + "em" });
            ...
            RenderedCell.prototype.startEditing = function (key) {
                ...
                eInput.style.width = (this.column.actualWidth - 14) / 16 + 'em';
            ...
            RenderedCell.prototype.createParentOfValue = function () {
                if (this.checkboxSelection) {
                    ...
                    // eventually we call eSpanWithValue.innerHTML = xxx, so cannot include the checkbox (above) in this span
                    this.newWrapperSpan = new ag.vdom.VHtmlElement('ag-elem');
                    this.newWrapperSpan.addClass('ag-cell-value-new');
                    this.vGridCell.appendChild(this.newWrapperSpan);
                    this.vParentOfValue = this.newWrapperSpan;
        ...
        var RenderedRow = (function () {
            function RenderedRow(gridOptionsWrapper, valueService, parentScope, angularGrid, columnController, expressionService, cellRendererMap, selectionRendererFactory, $compile, templateService, selectionController, rowRenderer, eBodyContainer, ePinnedContainer, node, rowIndex, eventService) {
                ...
                if (!this.gridOptionsWrapper.isForPrint()) {
                    this.vBodyRow.style.top = (this.gridOptionsWrapper.getRowHeight() * this.rowIndex) / 16 + "em";
                    if (this.pinning) {
                        this.vPinnedRow.style.top = (this.gridOptionsWrapper.getRowHeight() * this.rowIndex) / 16 + "em";
                    }
                }
                this.vBodyRow.style.height = (this.gridOptionsWrapper.getRowHeight()) / 16 + "em";
                if (this.pinning) {
                    this.vPinnedRow.style.height = (this.gridOptionsWrapper.getRowHeight()) / 16 + "em";
                }
            ...
            RenderedRow.prototype.setMainRowWidth = function (width) {
                this.vBodyRow.addStyles({ width: width / 16 + "em" });
            };
        ...
        function groupCellRendererFactory(gridOptionsWrapper, selectionRendererFactory, expressionService) {
            return function groupCellRenderer(params) {
                ...
                if (!suppressPadding && (node.footer || node.level > 0)) {
                    ...
                    eGroupCell.style.paddingLeft = paddingPx / 16 + 'em';
                }
                return eGroupCell;
            };
    ...
    (function (grid) {
        ...
        var RowRenderer = (function () {
            ...
            RowRenderer.prototype.onIndividualColumnResized = function (column) {
                var newWidthPx = column.actualWidth / 16 + "em";
            ...
            RowRenderer.prototype.setMainRowWidths = function () {
                var mainRowWidth = this.columnModel.getBodyContainerWidth() / 16 + "em";
            ...
            RowRenderer.prototype.refreshView = function (refreshFromIndex) {
                if (!this.gridOptionsWrapper.isForPrint()) {
                    ...
                    this.eBodyContainer.style.height = containerHeight / 16 + "em";
                    this.ePinnedColsContainer.style.height = containerHeight / 16 + "em";
                }
    ...
    (function (grid) {
        ...
        var BorderLayout = (function () {
            ...
            BorderLayout.prototype.layoutWidth = function () {
                ...
                //this.eCenterWrapper.style.width = centerWidth/16 + 'em';
                this.eCenterWrapper.style.width = '100%';
            };
    ...
    (function (grid) {
        ...
        var GridPanel = (function () {
            ...
            GridPanel.prototype.setBodyContainerWidth = function () {
                //var mainRowWidth = this.columnModel.getBodyContainerWidth()/16 + 'em';
                this.eBodyContainer.style.width = '100%';
                if (!this.forPrint) {
                    this.eFloatingBottomContainer.style.width = '100%';
                    this.eFloatingTopContainer.style.width = '100%';
                }
            };
            GridPanel.prototype.setPinnedColContainerWidth = function () {
                ...
                var pinnedColWidth = this.columnModel.getPinnedContainerWidth() / 16 + 'em';
            ...
            GridPanel.prototype.sizeHeaderAndBodyNormal = function () {
                ...
                this.eHeader.style['height'] = headerHeight / 16 + 'em';
                ...
                this.eBody.style.paddingTop = paddingTop / 16 + 'em';
                this.eBody.style.paddingBottom = floatingBottomHeight / 16 + 'em';
                this.eFloatingTop.style.top = headerHeight / 16 + 'em';
                this.eFloatingTop.style.height = floatingTopHeight / 16 + 'em';
                this.eFloatingBottom.style.height = floatingBottomHeight / 16 + 'em';
                this.eFloatingBottom.style.top = floatingBottomTop / 16 + 'em';
                this.ePinnedColsViewport.style.height = heightOfCentreRows / 16 + 'em';
            };
            GridPanel.prototype.sizeHeaderAndBodyForPrint = function () {
                var headerHeightPixels = this.gridOptionsWrapper.getHeaderHeight() / 16 + 'em';
            ...
            GridPanel.prototype.scrollHeader = function (bodyLeftPosition) {
                ...
                this.eHeaderContainer.style.left = -bodyLeftPosition / 16 + 'em';
                this.eFloatingBottomContainer.style.left = -bodyLeftPosition / 16 + 'em';
                this.eFloatingTopContainer.style.left = -bodyLeftPosition / 16 + 'em';
            };
            GridPanel.prototype.scrollPinned = function (bodyTopPosition) {
                // this.ePinnedColsContainer.style.transform = 'translate3d(0,' + -bodyTopPosition + 'px,0)';
                this.ePinnedColsContainer.style.top = -bodyTopPosition / 16 + 'em';
            };
            return GridPanel;
        })();
    ...
    (function (grid) {
        ...
        var AgDropdownList = (function () {
            ...
            AgDropdownList.prototype.setWidth = function (width) {
                this.eValue.style.width = width / 16 + 'em';
                this.agList.addStyles({ width: width / 16 + 'em' });
            };
